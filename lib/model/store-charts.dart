...
class AllTime {
  ...
  List<dynamic>? allTransferredSales;
  ...
  factory AllTime.fromJson(Map<String, dynamic> json) => AllTime(
    ...
    allTransferredSales: List<dynamic>.from(json['allTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'allTransferredSales': List<dynamic>.from(allTransferredSales!.map((x) => x)),
...
class SixMonth {
  ...
  List<dynamic>? sixMonthTransferredSales;
  ...
  factory SixMonth.fromJson(Map<String, dynamic> json) => SixMonth(
    ...
    sixMonthTransferredSales: List<dynamic>.from(json['sixMonthTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'sixMonthTransferredSales': List<dynamic>.from(sixMonthTransferredSales!.map((x) => x)),
...
class ThisMonth {
  ...
  List<dynamic>? monthTransferredSales;
  ...
  factory ThisMonth.fromJson(Map<String, dynamic> json) => ThisMonth(
    ...
    monthTransferredSales: List<dynamic>.from(json['monthTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'monthTransferredSales': List<dynamic>.from(monthTransferredSales!.map((x) => x)),
...
class Today {
  ...
  List<dynamic>? todayTransferredSales;
  ...
  factory Today.fromJson(Map<String, dynamic> json) => Today(
    ...
    todayTransferredSales: List<dynamic>.from(json['todayTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'todayTransferredSales': List<dynamic>.from(todayTransferredSales!.map((x) => x)),
...
class Week {
  ...
  List<dynamic>? weekTransferredSales;
  ...
  factory Week.fromJson(Map<String, dynamic> json) => Week(
    ...
    weekTransferredSales: List<dynamic>.from(json['weekTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'weekTransferredSales': List<dynamic>.from(weekTransferredSales!.map((x) => x)),
...
class Yesterday {
  Yesterday({
    this.yesterdaySales,
    this.yesterdayTransferredSales,
  ...
  List<dynamic>? yesterdayTransferredSales;
  ...
  factory Yesterday.fromJson(Map<String, dynamic> json) => Yesterday(
    ...
    yesterdayTransferredSales: List<dynamic>.from(json['yesterdayTransferredSales'].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'yesterdayTransferredSales': List<dynamic>.from(yesterdayTransferredSales!.map((x) => x)),
