                ...
                child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'This means that this Customer will no longer be available. This action cannot be undone.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Customer has been deleted successfully. Go back to review other customers',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Color(0xFF000428).withOpacity(0.6),
                              fontWeight: FontWeight.w400,
